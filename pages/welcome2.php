...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["maquina"])) || empty(trim($_POST["obra"])) || empty(trim($_POST["combustivel"])) || empty(trim($_POST["litros"])) || empty(trim($_POST["km"])) || empty(trim($_POST["horas"]))) {
    ...
    if (empty($maquina_err) && empty($obra_err) && empty($combustivel_err) && empty($litros_err) && empty($km_err) && empty($horas_err) && empty($assinatura_err)) {
